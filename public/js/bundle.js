...
var displayMap = function displayMap(locations) {
  mapboxgl.accessToken = 'pk.eyJ1IjoibGVvbnVjaCIsImEiOiJjazJuMm5oNWIwbWNnM29xdXBtbHN2dnhvIn0.3hyrfy1HjccQOSliCQ6EQg';
  var map = new mapboxgl.Map({
    container: 'map',
    style: 'mapbox://styles/leonuch/ckxm5rtrynbni15nsk4yxzay0',
    scrollZoom: false // center: [-118.803461, 34.116072],
    // zoom: 10,
    // interactive: false,
        ...
        switch (_context.prev = _context.next) {
          ...
          case 3:
            ...
            if (res.data.status === 'success') {
              (0, _alerts.showAlert)('success', 'Logged in successfully!'); // to reload another page
...
var stripe = Stripe('pk_test_51KDkJvIpIGEtB5Y1UVugXiYp2LbuH6YtVKnb0ZGOJAKFO5Pj6kxTZargr8UooVqJSwOVKNU7qBBpBb5V043q7XmH00PqSXtqal');
...
if (bookBtn) bookBtn.addEventListener('click', function (e) {
  e.target.textContent = 'Processing...'; // change text
